...
data['question'] = 'What is the yield for ' + data['Crop'] + ' in ' + data['Crop_Year'].astype(str) + ' during ' + data['Season'] + '?'
...
# tokenizer = AutoTokenizer.from_pretrained("/root/my_model_directory/my_tokenizer")
# tokenizer = AutoTokenizer.from_pretrained("~/my_model_directory/my_tokenizer")
